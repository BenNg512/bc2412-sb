...
public class ScheduleConfig {
  ...
  // redis every hour update history data
  ...
  // update history data
  @Scheduled(cron = "0 30 * * * *", zone = "Asia/Hong_Kong")
  ...
  // redis every 5 mins update today's data
