package com.bootcamp.demo.demo_swagger.controller;
...
public interface StockOperation {
  ...
  @ResponseStatus(value = HttpStatus.OK)
  public StockDTO updateStock(@RequestParam String symbol,
      @RequestBody StockDTO stockDTO);

  @PatchMapping(value = "/stock")
  @ResponseStatus(value = HttpStatus.OK)
  public StockDTO patchStockDescription(@RequestParam String symbol,
      @RequestParam String stockDescription);
}
