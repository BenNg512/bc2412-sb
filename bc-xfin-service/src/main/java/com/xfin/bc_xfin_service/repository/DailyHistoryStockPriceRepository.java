...
public interface DailyHistoryStockPriceRepository extends JpaRepository<DailyHistoryStockPriceEntity, Long> {
  ...
  List<DailyHistoryStockPriceEntity> findData(String symbol, Long start, Long end);
}
